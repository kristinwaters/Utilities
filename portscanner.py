...
# We used Queue() class from the built-in queue module that will help us with consuming ports, the two below functions are for 
# producing and filling up the queue with port numbers and using threads to consume them:
def main(host, ports):
    global q
